 ...
 */
package cr.una.ac.kiosko.util;

import cr.una.ac.kiosko.App;
import cr.una.ac.kiosko.controller.Controller;
...
public class FlowController {
    ...
    public void goViewInWindow(String viewName) {
        ...
        stage.getIcons().add(new Image("/cr/una/ac/kiosko/resources/Agregar-48.png"));
